...
class GeneratorOptimizerConstructor:
    ...
    def __call__(self, model):
        ...
        if not self.paramwise_cfg:
            optimizer_cfg['params'] = model.generator.parameters() # model.parameters()
            print('Train the Generator only')
            return build_from_cfg(optimizer_cfg, OPTIMIZERS)
        print('You may want to rewrite the optimizaer towards to generator')
        exit()
