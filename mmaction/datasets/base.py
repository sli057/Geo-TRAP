...
class BaseDataset(Dataset, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        if self.sample_by_class:
            ...
            # print(len(self.video_infos_by_class))
            # for value in self.video_infos_by_class.values():
            #     print(len(value))
            # exit()
    ...
    def evaluate(self,
        ...
        # assert len(results) == len(self), ( #shasha
        #     f'The length of results is not equal to the dataset len: '
        #     f'{len(results)} != {len(self)}')
        # shasha
        if len(results) < len(self): #shasha
            print('\ntest {:d} out of all {:d} samples'.format(len(results), len(self)))
        ...
        eval_results = {}
        gt_labels = [ann['label'] for ann in self.video_infos[:len(results)]] #shasha
    ...
    def __len__(self):
        ...
        if self.sample_by_class:
            return len(self.video_infos_by_class)
